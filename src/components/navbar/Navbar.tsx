    ...
    <div className=" h-[72px]  flex justify-between items-center px-32 bg-tertiary-500 shadow ">
      ...
      <div className=" flex items-center space-x-2">
        <CustomButton
          ...
          containerStyles=" py-[5px] bg-primary-400 text-secondary-400 rounded-lg font-light px-4 text-xl border border-primary-600 "
        />
        <CustomButton
          iconBefore={<Cart iconStyle="w-6" />}
          title="0"
          containerStyles=" py-[5px] border border-primary-500 text-secondary-600 rounded font-light text-xl px-4 bg-primary-400 font-black hover:scale-110 transition-all"
        />
      </div>
    </div>
  );
